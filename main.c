...
int getChoice();
void clear();
int createSettlement(Settlement settlement[], int settlementCount);
...
int createSettlement(Settlement settlementList[], int settlementCount) {

    if (settlementCount == 20) {
        printf("Settlement count limit reached!\n");
        return 20;
    }
    else {
        get
